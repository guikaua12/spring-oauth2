package me.approximations.authorizationserver.config;
...
public class SecurityConfig {
    ...
    public UserDetailsService userDetailsService() {
        final UserDetails user = User.withUsername("member")
                .password("{noop}12345")
                .roles("MEMBER")
                .build();
    ...
    public RegisteredClientRepository registeredClientRepository() {
        final RegisteredClient client = RegisteredClient.withId("1")
                .clientId("client")
